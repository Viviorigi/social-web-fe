        ...
        <form onSubmit={formik.handleSubmit} >
          <div>
            <div className='flex space-x-4 items-center'>
              ...
              <div>
                <p className='font-bold text-lg'>{auth.user.firstName ? auth.user.firstName + ' ' + auth.user.lastName : ''}</p>
                <p className='text-sm'>{auth.user.firstName ? '@' + auth.user.firstName.toLowerCase() + '' + auth.user.lastName.toLowerCase() : ''}</p>
              </div>
            </div>
            ...
            {selectedVideo && <div>
              <video className='h-[10rem]' controls src={selectedVideo} alt="" />
            </div>}
